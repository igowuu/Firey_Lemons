...
class SwerveModule:
    def __init__(self, drive_id: int, steer_id: int, cancoder_id: int) -> None:
        ...
        self.steer_ff = SimpleMotorFeedforwardMeters(STEER_KS, STEER_KV, STEER_KA)
    ...
    def _applySteerControl(self, desired_angle: float):
        ...
        ff_voltage = self.steer_ff.calculate(0.0) # Needs desired angular velocity (m/s)
    ...
    def setDesiredState(self, desired_state: SwerveModuleState) -> None:
        ...
        current_rotor_rate = self.drive_motor.get_velocity().value  # meters/sec
